...
ui_print(" ");
ui_print("__________$$$$$$     ");
ui_print("_________$$_LG_$$    ");
ui_print("_________$$$__$$$    ");
ui_print("_________$$_$$_$$    ");
ui_print("_________$$____$$    ");
ui_print("_________$$____$$    ");
ui_print("_________$$____$$    ");
ui_print("_________$$____$$$$$$$    ");
ui_print("___$$$$$$$$____$$____$$    ");
ui_print("_$$$$$___$$____$$____$$$$$$    ");
ui_print("$$$_$$___$$____$$____$$___$$    ");
ui_print("$$__$$___$$____$$____$$___$$    ");
ui_print("$$__$$___$$____$$____$$___$$    ");
ui_print("$$__$$___$$____$$___$$$___$$    ");
ui_print("$$__$$___$$____$$____$____$$    ");
ui_print("$$____$$$__$$$$__$$$$___$_$$    ");
ui_print("$$________________________$$    ");
ui_print("_$$_______LGV20_________$$    ");
ui_print("_$$$__Team DevDigitel___$$    ");
ui_print("__$$$$___Take_Back_____$$$    ");
ui_print("____$$___Our_Devices___$    ");
ui_print("____$$$_______________$$    ");
ui_print(" ");
ui_print(" ");
ui_print(" ");
ui_print (" Team DevDigitel Presents ");
ui_print(" ");
ui_print (" Stock-Ish Debloated ");
ui_print (" Rooted and Optimized");
ui_print(" ");
ui_print (" LG V20 ZV5 7.0 Android N");
ui_print(" ");
ui_print (" Be Prepared To Have Some Fun");
ui_print (" Version 6.0 De-odexed Rom");
ui_print ("    Magisk Managed    ");
ui_print(" ");
ui_print(" ");
ui_print(" ");
ui_print("######################");
...
ui_print(" ");
format("ext4", "EMMC", "/dev/block/bootdevice/by-name/system" + file_getprop("/tmp/slotsel", "slotnum"), "0", "/system");
...
symlink("/firmware/image/secureks.b04", "/system/etc/firmware/secureks.b04");
...
symlink("/system/lib/libbluetooth_jni2.so", "/system/app/LGBluetooth4/lib/arm/libbluetooth_jni2.so");
...
set_metadata("/system/bin/ble_sniff_scan", "selabel", "u:object_r:ble_sniff_scan_exec:s0");
...
set_metadata("/system/vendor/bin/enable_uninstall.sh", "selabel", "u:object_r:enable_uninstall_exec:s0");
